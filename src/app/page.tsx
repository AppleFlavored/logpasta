...
import { MdShare, MdTroubleshoot } from 'react-icons/md';

export default function Home() {
    return (
        <>
            <div className="container mx-auto px-2 sm:p-0 max-w-3xl mt-16">
                <UploadContainer />
                <p className="text-center text-[#3f4d5a] text-sm mt-2">(Max file size: 5 MB)</p>
            </div>
            <div className="container mx-auto px-2 sm:p-0 grid grid-rows-2 sm:grid-cols-2 gap-16 max-w-4xl mt-16">
